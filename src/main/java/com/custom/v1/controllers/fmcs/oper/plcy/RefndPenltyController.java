...
/**
 * @ClassName : RefndPenltycontrollers.java
 * @Description : 환불위약금설정에 관한 controller 클래스를 정의한다.
 *
 * @author : 김영철
 * @since  : 2022-11-01
 * @version : 1.0
...
@Tag(
     name = "환불위약금설정",
     description = "운영 설정관리 - 업무운영정책기준설정 - 환불운영정책설정 - 환불위약금설정"
    )
@RestController
@RequestMapping("/api/v1/fmcs/{instt}/oper")
public class RefndPenltyController {
    ...
    public String selectRefndPenltyList(
            @PathVariable("instt") final String instt
            ) {
        return "selectRefndPenltyList";
    }
    ...
    public String selectRefndPenlty(
            @PathVariable("instt") final String instt,
            @PathVariable("id") final String id
            ) {
        return "selectRefndPenlty";
    }
    ...
    public String insertRefndPenlty(
            @PathVariable("instt") final String instt
            ) {
        return "insertRefndPenlty";
    }
    ...
    public String updateRefndPenlty(
            @PathVariable("instt") final String instt,
            @PathVariable("id") final String id
            ) {
        return "updateRefndPenlty";
    }
    ...
    public String deleteRefndPenlty(
            @PathVariable("instt") final String instt,
            @PathVariable("id") final String id
            ) {
        return "deleteRefndPenlty";
    }
}
