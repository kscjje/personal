...
/**
 * @ClassName : SystemCodecontrollers.java
 * @Description : 시스템코드에 관한 controller 클래스를 정의한다.
 *
 * @author : 김영철
 * @since  : 2022-11-02
 * @version : 1.0
...
@Tag(
     name = "시스템코드관리",
     description = "시스템관리 - 시스템코드관리"
    )
@RestController
@RequestMapping("/api/v1/fmcs/{instt}/sys")
public class SystemCodeController {

    @Operation(summary="시스템코드 목록 조회", description="시스템코드 목록을 조회한다.")
    @ApiResponses(value = {
    ...
    @Operation(summary="시스템코드 정보 조회", description="시스템코드 정보 한건을 조회한다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공"),
            @ApiResponse(responseCode = "400", description = "실패"),
            @ApiResponse(responseCode = "404", description = "실패2")
    ...
    @Operation(summary="시스템코드 정보 등록", description="시스템코드 정보를 등록한다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공"),
            @ApiResponse(responseCode = "400", description = "실패"),
            @ApiResponse(responseCode = "404", description = "실패2")
    ...
    @Operation(summary="시스템코드 정보 수정", description="시스템코드 정보를 수정한다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공"),
            @ApiResponse(responseCode = "400", description = "실패"),
            @ApiResponse(responseCode = "404", description = "실패2")
    ...
    @Operation(summary="시스템코드 정보 삭제", description="시스템코드 정보를 삭제한다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공"),
            @ApiResponse(responseCode = "400", description = "실패"),
            @ApiResponse(responseCode = "404", description = "실패2")
