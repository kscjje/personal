...
/**
 * @ClassName : MypageLecturecontrollers.java
 * @Description : 수강신청현황에 관한 controller 클래스를 정의한다.
 *
 * @author : 김영철
 * @since  : 2022-11-15
 * @version : 1.0
...
@Tag(name = "2. 05. 마이페이지 - 02) 수강신청현황",
     description = """
             회원이 신청한 수강신청현황 정보를 관리한다.
             """
    )
@RestController
@RequestMapping("/api/v1/frnt/{instt}/mypg")
public class MypageLectureController {
