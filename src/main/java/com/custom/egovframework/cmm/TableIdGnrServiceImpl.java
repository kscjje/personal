 ...
 * </pre>
 */
public class TableIdGnrServiceImpl extends AbstractDataBlockIdGnrService {

    private static final Logger LOGGER = LoggerFactory.getLogger(TableIdGnrServiceImpl.class);
    ...
    private Object insertInitId(final boolean useBigDecimals, final int blockSize) {
        LOGGER.debug("[IDGeneration Service] TABLE_NAME = '{}'에 대한 초기 id 값을 삽입합니다.", tableName, Locale.getDefault());
        Object initId = null;
    ...
    private Object allocateIdBlock(final int blockSize, final boolean useBigDecimals) throws FdlException {
        LOGGER.debug("[IDGeneration Service] key_table에 대한 {} ID의 새로운 블록을 할당 {}.", new Integer(blockSize), tableName, Locale.getDefault());
        try {
